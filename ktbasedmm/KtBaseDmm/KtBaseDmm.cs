...
namespace Keysight.KtBaseDmm
{
    /// <summary>
    /// Class <c>KtBaseDmm</c> for a sample Dmm driver proto code.
    /// </summary>
    public sealed class KtBaseDmm : IKtBaseDmm, IDisposable
    {
        ...
        /// </summary>
        public string Vendor => "Keysight Technologies";
        ...
        /// </summary>
        public KtBaseDmm(string resourceName, bool idQuery, bool reset, string options)
        {
